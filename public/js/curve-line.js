...
export function drawCurveLine(dataset_curve) {
  ...
  createGradient(gradient_svg,'curve-line-gradient',[ // Create gradient
      { offset: '0%', 'stop-color': '#44A484 ', 'stop-opacity': '0.45' },
      { offset: '75%', 'stop-color': '#FFFFFF', 'stop-opacity': '0.05' }
  ]);

  svg_curve.append("path")
    .attr("d", area(dataset_curve))
    .attr("class", "streamPath")
    .style('fill', "url(#curve-line-gradient)")
